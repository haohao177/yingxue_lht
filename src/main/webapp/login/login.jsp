    ...
    <script>
        $(function () {
            ...
            $.extend($.validator.messages, {
                //验证必填字段 在需要的input上加入 required属性
                required: "<span style='color:red'><strong>这是必填字段<strong></span>",
                //验证最少输入字符 在需要的inpu 上加入minlength=4 属性
                minlength: $.validator.format("<span style='color:red'><strong>最少输入4个字符<strong></span>"),
            });
            //异步提交
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" minlength=4 placeholder="请输入密码..."
                            ...
                            <div class="form-group">
                                ...
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
                                       required type="test" minlength=4 name="enCode" id="form-code">
                            </div>
